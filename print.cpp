...
void printVariable(astVariable *variable, bool nameOnly) {
...
void printFunctionVariable(astFunctionVariable *variable, int flags) {
	if (variable->isConst)
		print("const ");
	printVariable((astVariable*)variable);
	if (variable->initialValue) {
...
void printDeclarationStatement(astDeclarationStatement *statement, int flags) {
	for (size_t i = 0; i < statement->variables.size(); i++)
		printFunctionVariable(statement->variables[i], flags);
}

void printExpressionStatement(astExpressionStatement *statement, int flags) {
